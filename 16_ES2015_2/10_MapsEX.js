class MessageBoard {
    ...
    */
    ...
    Add a method called addMessage which accepts a string. The function should add a key and value to the messages map with a key of whatever the value of this.id is 
    and a value of whatever the string is that is passed to the function. The function should return the object created from the class so that the method can be chained. 
    ...
    */
    ...
    messagesToArray() {
        return Array.from(this.messages.value());
    }
}
...
function countPairs(arr, num) {
    ...
    for(let val of arr){
        //delete every repeated value
        cache.delete(val);
        //if there is any pair of unique number that adds to number add to count. 1 value from set and another from array.
