...
add.on('click',() =>{
  quotes = quotes.concat(newQuotes);
    ...
    var existingListItems = d3.select("#quotes")
    .selectAll("li")
    .data(quotes);
  ...
  existingListItems
    ...
    .append("li")
      ...
      //merge the new items to the existing list Items
      .merge(existingListItems);

      //remove the button from the page so we cant add these again
  add.remove();
})
